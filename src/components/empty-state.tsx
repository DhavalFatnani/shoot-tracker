...
const defaultIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto h-14 w-14 text-slate-300 dark:text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden>
...
export function EmptyState({ icon = defaultIcon, title, description, action, onAction, actionLabel }: EmptyStateProps) {
  return (
    <div className="card card-hover flex flex-col items-center justify-center px-8 py-20 text-center">
      <div className="mx-auto max-w-sm">
        {icon}
        <h3 className="font-display mt-5 text-lg font-semibold text-slate-900 dark:text-slate-100">{title}</h3>
